...
from brambl.metadata import ImmutableDict, Metadata
...
class MetadataValidationTestCase(unittest.TestCase):
    ...
    def test_invalid_string_value(self):
        ...
        with self.assertRaises(ValueError):
            m[1] = "1234567890123456789012345678901234567890123456789012345678901234512345678901234567890123456789012345678901234567890123456789012345"
        with self.assertRaises(ValueError):
            m[
                1
            ] = "1234567890123456789012345678901234567890123456789012345678901234512345678901234567890123456789012345678901234567890123456789012345".encode(
                "ascii"
            )
        with self.assertRaises(ValueError):
            m[1] = bytearray(
        ...
        with self.assertRaises(ValueError):
            Metadata(
                [
                    (
                        1,
                        "1234567890123456789012345678901234567890123456789012345678901234512345678901234567890123456789012345678901234567890123456789012345",
                    )
                ]
            )
        with self.assertRaises(ValueError):
...
class MetadataSerDeserTestCase(unittest.TestCase):
    ...
    def test_deserialize_complex(self):
        ...
        self.assertDictEqual(
            m[17200655244803120463], {ImmutableDict(): "G", "zNXD7qk": []}
        )
