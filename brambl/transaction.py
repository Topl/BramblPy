...
class IOBase(object):
    ...
    """
        Underlying parent class for different representations of UTXO transactions
...
class TransactionRequest(IOBase):
    """
        Represents a Topl Transaction request
    ...
    def __init__(self, sender = None, recipients = None, consolidationAddress = None, changeAddress = None, assetCode = None, **kwargs):
        super(TransactionRequest, self).__init__(**kwargs)
...
class Transaction(IOBase):
    """
        Represents a Topl Transaction (any of the forms that are generated by a Bifrost node)
